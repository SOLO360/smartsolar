...
$id = $fetch['id'];
$c_no = "SS/C:".$id;*/
$date_plus_60_days = date('Y-m-d', strtotime('+ 548 days', time()));
if (isset($_FILES['picture'])) {
 ...
 {  $date_plus_60_days = date('Y-m-d', strtotime('+ 548 days', time()));
    ...
    $sql2 = "SELECT * FROM customers WHERE fname = '$fname' ,mname='$mname',lname='$lname',addres='$adres',phone='$phone',gender='$jinsia',id_card_no='$id_no'";
    $check = mysqli_query($conn, $sql2);
    $row = mysqli_num_rows($check);
    if ($row > 0 ) {
      echo '<div class="alert alert-danger"><a class="close" aria-label="close" data-dismiss="alert">&times;</a>Customer Already exists</div>';
    }else{
      $sql = "INSERT INTO customers (fname,mname,lname,addres,dob,phone,gender,id_card_type,id_card_no,bulb_no,charger,clerk_name,reg_date,s_date,service_type,status,image,cont_end,amount) VALUES
      ('$fname','$mname','$lname','$adres','$dob','$phone','$jinsia','$id_type','$id_no','$bulb','$chaji','$clerk','$regdate','$sdate','$stype','$status','$file_name','$mwisho','$amount')";
                ...
                <form class="user" method="POST" enctype="multipart/form-data">
                  <div class="form-group row">
                    <div class="col-sm-4 mb-3 mb-sm-0">
                      <input type="text" class="form-control " id="exampleFirstName" placeholder="First Name" name="fname" required >
                    </div>
                    <div class="col-sm-4 mb-1">
                      <input type="text" class="form-control " id="exampleLastName" placeholder="Middle Name" name="mname" required>
                    </div>
                    <div class="col-sm-4 mb-1">
                      <input type="text" class="form-control " id="exampleLastName" placeholder="Last Name" name="lname" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-4 mb-3 mb-sm-0">
                      <input type="text" class="form-control " id="exampleFirstName" placeholder="Address" name="adres" required>
                    </div>
                    <div class="col-sm-4 mb-1">
                      <input type="date" class="form-control " id="exampleLastName" placeholder="Date Of Birth" name="dob" required>
                    </div>
                    <div class="col-sm-4">
                      <input type="text" class="form-control " id="exampleLastName" placeholder="Phone" name="phone" required pattern="[0-9]{10}"  title="Number of characters should not exceed 10">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control " id="idt" placeholder="Id-card No" name="id_no" style="visibility:hidden;">
                  </div>
                </div>
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      ...
                      <select class="form-control" name="bulb" required>
                        <option value="">--Number of bulbs--</option>
                    ...
                    <div class="col-sm-6 mb-sm-0">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="Charger" name="charger" value="charger">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      <input type="date" class="form-control" id="exampleFirstName" placeholder="Start-Date" name="sdate" value="<?php echo  $currentDateTime = date('Y-m-d'); ?>">
                    </div>
                    ...
                    <div class="col-sm-3 mb-sm-0">
                      <select class="form-control" id="stype" name="status"  required>
                        ...
                        <option value="pending">Awaiting Installation</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="col-sm-3 mb-sm-0">
                    <div class="custom-file overflow-hidden rounded-pill mb-5">
                      <input id="customFile" type="file" class="custom-file-input" name="picture">
                      <label for="customFile" class="custom-file-label rounded-pill">Choose file</label>
                    </div>
                  </div>
                    <div class="col-sm-3 mb-sm-0">
                    <input type="date" class="form-control " id="endContractdate" placeholder="Id-card No" name="enCdate" style="visibility:hidden;" value="<?php 
                    echo $date_plus_60_days; ?>">
                  </div>
                </div>
                  <input type="submit" name="register"  value="Register Customer"class="btn btn-primary btn-user btn-block">
                  <hr>
                </form>
              </div>
            </div>
